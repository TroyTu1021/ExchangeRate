sap.ui.define([
	...
	return BaseObject.extend("addon.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias addon.model.ListSelector
		 */
		 ...
		 * @return {addon.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
